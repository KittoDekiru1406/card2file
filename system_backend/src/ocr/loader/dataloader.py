...
from ocr.tool.translate import process_image
from ocr.tool.create_dataset import createDataset
from ocr.tool.translate import resize
...
class OCRDataset(Dataset):
    def __init__(
        ...
        if os.path.isdir(self.lmdb_path):
            print(
                "{} exists. Remove folder if you want to create new dataset".format(
                    self.lmdb_path
                )
            )
            sys.stdout.flush()
